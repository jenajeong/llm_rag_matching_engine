...
EBSCO_USERNAME = os.environ.get("EBSCO_USERNAME", "").strip()
EBSCO_PASSWORD = os.environ.get("EBSCO_PASSWORD", "").strip()
...
INDIGO_API_URL = os.environ.get("INDIGO_API_URL", "https://indigo.inu.ac.kr/other/inuapi/list.do").strip()
INDIGO_API_KEY = os.environ.get("INDIGO_API_KEY", "").strip()
INDIGO_API_TIMEOUT = int(os.environ.get("INDIGO_API_TIMEOUT", "30"))
...
MIN_TEXT_LENGTH = int(os.environ.get("INDIGO_MIN_TEXT_LENGTH", "100"))
